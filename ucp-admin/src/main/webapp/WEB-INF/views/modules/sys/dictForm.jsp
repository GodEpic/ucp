...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/sys/dict/list?id=${dict.parent.id}&parentIds=${dict.parentIds}">字典列表</a></li>
    <%--<li class="active"><a href="${ctx}/sys/dict/form?id=${dict.id}">--%>
    <li class="active"><a href="${ctx}/sys/dict/form?id=${dict.id}&parent.id=${dict.parent.id}">
...
<form:form id="inputForm" modelAttribute="dict" action="${ctx}/sys/dict/save" method="post" class="form-horizontal">
    ...
    <div class="control-group">
        <label class="control-label">上级字典:</label>
        <div class="controls">
            <sys:treeselect id="dict" name="parent.id" value="${dict.parent.id}" labelName="parent.label"
                            labelValue="${dict.parent.label}"
                            title="字典" url="/sys/dict/treeData" extId="${dict.id}" cssClass=""/>
        </div>
    </div>
    <div class="control-group">
