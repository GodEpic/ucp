...
import com.yum.ucp.common.servlet.ValidateCodeServlet;
...
import com.yum.ucp.modules.sys.security.SystemAuthorizingRealm.Principal;
...
//		try {
//			byte[] bytes = com.yum.ucp.common.utils.FileUtils.readFileToByteArray(
//					com.yum.ucp.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
