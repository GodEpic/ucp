    ...
    <div id="case">
        <div class="">
            <form id="activityForm" class="layui-form">
                <div class="sec">
                    ...
                    <div class="sec-form">
                        ...
                        <li>
                            ...
                            <input readonly="true" type="text" name="notifyActivityNo" id="notifyActivityNo"
                                   value="${activity.notifyActivityNo}" required>
                        </li>
                    </div>
                    <div class="sec-form">
                        <li>
                            ...
                            <select name="brand" required>
                                <c:forEach items="${fns:getDictList('brand')}" var="g">
                                    <option value="${g.value}" title="${g.description}"
                                            <c:if test="${g.value == activity.brand}">selected</c:if>>${g.label}</option>
                                </c:forEach>
                            </select>
                        </li>
                        <li>
                            ...
                            <select name="couponType" required>
                                <c:forEach items="${fns:getDictList('couponType')}" var="g">
                                    <option value="${g.value}" title="${g.description}"
                                            <c:if test="${g.value == activity.couponType}">selected</c:if>>${g.label}</option>
                                </c:forEach>
                            </select>
                        </li>
                        <div class="clear"></div>
                    ...
                    <div class="sec-form">
                        ...
                        <li>
                            ...
                            <input type="text" name="couponCount" class="required digits input-small" min="1" max="999"
                                   value="${activity.couponCount}"/>
                        </li>
                        <div class="clear"></div>
                    </div>
                    <div class="sec-form">
                        <li>
                            ...
                            <input id="confFinishedTime" name="confFinishedTime" type="text" maxlength="20"
                                   ...
                                   onchange="calculateDate(this)" required/>
                        </li>
                        <li>
                            <label><b class="label">*</b>建议测试时间：</label>
                            <input id="recommendedTestTime" name="recommendedTestTime" type="text" maxlength="20"
                                   class="input-medium Wdate "
                                   value="${activity.recommendedTestTime}" readonly="readonly"
                                   onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',isShowClear:true, minDate: '#F{$dp.$D(\'confFinishedTime\')}'});"
                                   required/>
                        </li>
                        <div class="clear"></div>
                    </div>
                    <div class="sec-form">
                        <li>
                            ...
                            <input id="testFinishedTime" name="testFinishedTime" type="text" maxlength="20"
                                   class="input-medium Wdate "
                                   value="${activity.testFinishedTime}" readonly="readonly"
                                   onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',isShowClear:true, minDate: '#F{$dp.$D(\'recommendedTestTime\')}'});"
                                   required/>
                        </li>
                        <li>
                            <label><b class="label">*</b>上架时间：</label>
                            <input id="launchTime" name="launchTime" type="text" maxlength="20"
                                   class="input-medium Wdate "
                                   value="${activity.launchTime}" readonly="readonly"
                                   onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',isShowClear:true, minDate: '#F{$dp.$D(\'testFinishedTime\')}'});"
                                   required/>
                        </li>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="sec-form">
                            ...
                            <select name="priority" required>
                                ...
                                <c:forEach items="${fns:getDictList('priority')}" var="g">
                                    <c:if test="${roleType == 6 or (activity.priority == 1 and g.value == 1)}">
                                        <option value="${g.value}" title="${g.description}"
                                                <c:if test="${g.value == activity.priority or (g.value == 3 and activity.priority == null)}">selected</c:if>>${g.label}</option>
                                    </c:if>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                ...
                                <input type="radio" name="keyconfigif" value="0" lay-skin="primary" title="不需要"
                                       checked="checked">
                            </div>
                        </div>
                        <div class="clear"></div>
                    ...
                    <div class="sec-form">
                        ...
                        <div class="sec-import">
                            <div class="import-btn">
                                ...
                                <input id="importExcel" type="file" name="importData" style="display:none"
                                       onchange="uploadFile()"
                        ...
                        <div class="import-result">
                            <table class="importTable">
                                ...
                                <tr>
                                    <td align="center" class="import-desc">已导入<span
                                            id="importDataSize">${couponCount}</span>条信息
                                    </td>
                                </tr>
                            </table>
                        </div>
                ...
                <div class="sec">
                    <div class="sec-top">
                        <span><button id="addActFile" type="button" class="layui-btn layui-btn-sm layui-coupon-btn"
                                      data-type="addActFile" title="添加图片和附件">+ 添加图片和附件</button></span>
                    </div>
                    <div class="sec-form">
                        ...
                        <section class="layui-col-md12" style="margin: 0 auto; float: none;">
                            <div class="layui-card">
                                <div class="layui-card-body layui-text">
                                    ...
                                    <div id="toolbar">
                                        <div>
                                            <button type="button" class="layui-btn layui-btn-sm layui-add-coupon"
                                                    data-type="addRow" title="添加券图">
                                                添加券图
                                            </button>
                                        </div>
                                    </div>
