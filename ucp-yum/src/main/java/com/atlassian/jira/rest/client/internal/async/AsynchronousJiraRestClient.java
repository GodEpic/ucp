 ...
 * @since v2.0
 */
public class AsynchronousJiraRestClient implements JiraRestClient,Serializable {

	/**
	 * 日志对象
	 */
	public org.slf4j.Logger logger = LoggerFactory.getLogger(AsynchronousJiraRestClient.class);
	...
	public void close() throws IOException {
		try {
			httpClient.destroy();
			logger.info("AsynchronousJiraRestClient  destroy");
		} catch (Exception e) {
