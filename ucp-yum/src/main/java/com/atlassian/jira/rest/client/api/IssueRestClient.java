...
public interface IssueRestClient {
	 ...
	 * @since com.atlassian.jira.rest.client.api 1.0, server 5.0
	 */
	Promise<Iterable<CimProject>> getCreateIssueMetadata( GetCreateIssueMetadataOptions options);
	...
	/**
	 * delete attachments to JIRA (adding it to selected issue)
	 *
	 * @param attachmentsUri where to upload the attachment. You can get this URI by examining issue resource first
	 * @since com.atlassian.jira.rest.client.api 0.2, server 4.3
	 */
	Promise<Void> deleteAttachment(URI attachmentsUri);
	...
	/**
	 * delete a comment to JIRA (adding it to selected issue)
	 *
	 * @param commentsUri where to add comment
	 * @since com.atlassian.jira.rest.client.api 1.0, server 5.0
	 */
	Promise<Void> deleteComment(URI commentsUri);

	/**
	 * update a comment to JIRA (adding it to selected issue)
	 *
	 */
	  Promise<Void> updateComment(URI commentsUri,  Comment comment) ;
	/**
