...
public class WorklogInput {
	 ...
	 */
	public WorklogInput( URI self, URI issueUri,  BasicUser author,  BasicUser updateAuthor,
			 String comment, DateTime startDate, int minutesSpent,  Visibility visibility,
			AdjustEstimate adjustEstimate,  String adjustEstimateValue) {
	...
	public static WorklogInput create(URI issueUri,  String comment, DateTime startDate, int minutesSpent) {
		return new WorklogInputBuilder(issueUri).setComment(comment).setStartDate(startDate).setMinutesSpent(minutesSpent)
				.build();
	}

	public static WorklogInput create(URI issueUri,  String comment, DateTime startDate, int minutesSpent,  Visibility visibility) {
		return new WorklogInputBuilder(issueUri).setComment(comment).setStartDate(startDate).setMinutesSpent(minutesSpent)
