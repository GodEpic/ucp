...
public class AuditRecordInputJsonGenerator implements JsonGenerator<AuditRecordInput> {
    ...
    private JSONArray generateChangedValues( Iterable<AuditChangedValue> changedValues) throws JSONException {
    ...
    protected JSONArray generateAssociatedItems( Iterable<AuditAssociatedItem> associatedItems) throws JSONException {
        final JSONArray array = new JSONArray();
