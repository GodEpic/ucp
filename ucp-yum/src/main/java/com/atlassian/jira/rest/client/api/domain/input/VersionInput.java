...
public class VersionInput {
	...
	public VersionInput(String projectKey, String name,  String description,  DateTime releaseDate,
	...
	public static VersionInput create(String projectKey, String name,  String description,  DateTime releaseDate,
