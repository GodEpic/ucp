 ...
 * @since v2.0
 */
public class AsynchronousHttpClientFactory implements Serializable{
	...
	/**
	 * These properties are used to present JRJC as a UserForTask-Agent during http requests.
	 */
