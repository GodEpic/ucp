...
public class CimFieldInfo implements NamedEntity, IdentifiableEntity<String> {
	...
	public CimFieldInfo(String id, boolean required,  String name, FieldSchema schema,
			Set<StandardOperation> operations,  Iterable<Object> allowedValues,  URI autoCompleteUri) {
		this.id = id;
