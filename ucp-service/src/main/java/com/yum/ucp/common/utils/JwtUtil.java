...
public class JwtUtil {
    ...
    public static final Long TIME = 600000L;
    ...
    public static void main(String[] args) throws Exception {
        ...
        String ab=util.createJWT("jwt", "{'customName':'张三','type':'10'}", 60000);
        String jwt=ab;
        System.out.println("tokan = "+ab);//jwt
    ...
    /*public static Map<String,Object> validateToken(String token) {
        ...
        if (token != null) {
            ...
            try {
                ...
                // don't trust the JWT!
                // jwt 解析错误
                resp.put("ERR_MSG","jwt 解析错误");
                return resp;
            } catch (ExpiredJwtException e) {
                // TODO: handle exception
                // jwt 已经过期，在设置jwt的时候如果设置了过期时间，这里会自动判断jwt是否已经过期，如果过期则会抛出这个异常，我们可以抓住这个异常并作相关处理。
                resp.put("ERR_MSG","jwt 已经过期");
                return resp;
            }
        }else {
