...
public class FtpUtils {
     ...
     * @throws Exception
     */
    public static JSONObject uploadSignalFile(MultipartFile file, String activityNo) throws Exception {
        JSONObject object = new JSONObject();
        FTPClient ftpClient = new FTPClient();
        try {
            connectFtp(ftpClient);
            ...
            String filePath;
            if (StringUtils.isNotBlank(activityNo)) {
                filePath = ftpPathUrl + createDirName + "/" + activityNo + "/" + originalFileName;
            } else {
                filePath = ftpPathUrl + createDirName + "/" + originalFileName;
            }
