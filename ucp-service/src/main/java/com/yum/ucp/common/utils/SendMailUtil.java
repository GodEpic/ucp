...
//	@SuppressWarnings("unchecked")
	...
	public static void main(String[] args) {
		 HtmlEmail hemail = new HtmlEmail();
		 try {
//		 hemail.setHostName("appsmtp.yumchina.com");
		 hemail.setHostName("172.31.88.31");
		 hemail.setSmtpPort(465);
		 hemail.setCharset("utf-8");
		 hemail.addTo("172141102@qq.com");
		 List list = Lists.newArrayList();
//		 list.add("China.rsc_ucp_einvoice@yumchina.com");

		 InternetAddress internetAddress = new InternetAddress("China.rsc_dsc_einvoice@yumchina.com");
		 list.add(internetAddress);

		 hemail.setBcc(list);
		 hemail.setFrom("China.rsc_dsc_einvoice@yumchina.com", "yumchina");
		 hemail.setAuthentication("rsc_dsc_einvoice", "Yum2017@");
		 hemail.setSubject("百胜电子发票");
		 hemail.setMsg("Dear :<br/>     您好！<br/>     附件是您的餐饮电子发票，请查收！<br/><br/><br/>  Best regard<br/>百胜电子发票后台");
		 hemail.send();
		 System.out.println("email send true!");
		 } catch (Exception e) {
		 e.printStackTrace();
