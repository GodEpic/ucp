...
public interface UserDao extends CrudDao<User> {
	 ...
	 * @return
	 */
	List<User> getNotBindUser();

    void setDisableLogin(User user);
	 ...
	 * @return
	 */
	List<User> findUserByIds(@Param("userIds") Object[] userIds);

	User findUserByWorkCode(@Param("workCode") String workCode);
}
