...
public class FormAuthenticationFilter extends org.apache.shiro.web.filter.authc.FormAuthenticationFilter {
	...
	private String username_external = null;
	private String password_external = null;

	protected AuthenticationToken createToken(ServletRequest request, ServletResponse response) {
		String username = getUsername(request);
		String password = getPassword(request);
		if(StringUtils.isNotEmpty(username_external)&&StringUtils.isNotEmpty(username_external)){
...
//		}
	...
	public void into(ServletRequest request, ServletResponse response,User userInfo){
		this.username_external = userInfo.getLoginName();
		this.password_external = userInfo.getPassword();
